...
public class Dresser implements IProduct {
	...
	public Dresser(FactoryLine<Object> marketingAnalyst, Warehouses<Object> storageChief,SoldProducts<Object> customer) {
	...
	public boolean isStored(Object product) {
		return StorageChief.contains(StorageChief.getDresser_warehouse(),StorageChief.getTop_dresser_warehouse(),product);
	}
